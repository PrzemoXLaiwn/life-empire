...
"[project]/Desktop/life-crime-game/app/api/events/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const events = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$life$2d$crime$2d$game$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].gameEvent.findMany({
            take: 20,
            orderBy: {
                createdAt: 'desc'
            }
        ...
        const eventsWithUsernames = await Promise.all(events.map(async (event)=>{
            if (event.userId) {
                try {
                    const { data: { user } } = await supabase.auth.admin.getUserById(event.userId);
                    return {
                        ...event,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__331f2c08._.js.map