...
async function main() {
  ...
  const fastFoodWorker = await prisma.job.create({
    data: {
      ...
      requiredSkills: {},
      hourlyRate: 15,
      shiftDurations: [4, 8, 12],
      energyCostPerHour: 10,
      stressCostPerHour: 15,
  ...
  const accountant = await prisma.job.create({
    data: {
      ...
      shiftDurations: [8],
      energyCostPerHour: 12,
      stressCostPerHour: 25,
      experiencePerHour: 30,
  ...
  const itSpecialist = await prisma.job.create({
    data: {
      ...
      shiftDurations: [8],
      energyCostPerHour: 10,
      stressCostPerHour: 18,
      experiencePerHour: 35,
  ...
  const realEstateAgent = await prisma.job.create({
    data: {
      ...
      shiftDurations: [8],
      energyCostPerHour: 12,
      stressCostPerHour: 22,
      experiencePerHour: 25,
  ...
  const seniorAccountant = await prisma.job.create({
    data: {
      ...
      shiftDurations: [8],
      energyCostPerHour: 15,
      stressCostPerHour: 30,
      experiencePerHour: 45,
  ...
  const lawyer = await prisma.job.create({
    data: {
      ...
      stressCostPerHour: 35,
      experiencePerHour: 60,
  ...
  const investmentBanker = await prisma.job.create({
    data: {
      ...
      stressCostPerHour: 40,
      experiencePerHour: 80,
